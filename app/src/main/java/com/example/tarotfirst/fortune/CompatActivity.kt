...
class CompatActivity : AppCompatActivity() {
    ...
    private fun compatShuffle() {
        ...
        val layoutCard1: ImageView = findViewById(R.id.cardViewSecond)
        val layoutCard2: ImageView = findViewById(R.id.cardViewThird)
        val layoutCard3: ImageView = findViewById(R.id.cardViewFourth)
        val layoutCard4: ImageView = findViewById(R.id.cardViewFifth)
        val layoutCard5: ImageView = findViewById(R.id.cardViewSixth)
        ...
        fun afterClick() {
            textCard.text = "Ваши желания в отношениях: \n" + getString(resourceTextOne) +
                    "\n\nЖелания партнера в отношениях: \n" + getString(resourceTextTwo) +
                    "\n\nВаши различия: \n" + getString(resourceTextThree) +
                    "\n\nВаши сходства: \n" + getString(resourceTextFourth) +
                    "\n\nЭмоциональная совместимость: \n" + getString(resourceTextFifth) +
